...
class CompanyInProgress extends StatefulWidget {
  @override
  _CompanyInProgressState createState() => _CompanyInProgressState();
}

class _CompanyInProgressState extends State<CompanyInProgress> {
